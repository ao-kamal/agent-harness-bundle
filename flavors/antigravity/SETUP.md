...
4. Deploys `~/.gemini/antigravity-cli/keybindings.json` (remaps `edit.paste` to `alt+v`) and `getclip.exe` helper for unbracketed paste in WezTerm, enabling Wispr Flow voice dictation and standard clipboard paste.
